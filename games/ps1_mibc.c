...
#define MIBC_playerbase_sanity 0x000008E5
...
static uint8_t PS1_MIBC_Status(void)
{
	// TODO: add check for SLUS-01387?
	return (PS1_MEM_ReadWord(0x200) == 0x58290000U && PS1_MEM_ReadWord(0x204) == 0x642A0000U); // values that don't change? after bios-stuff(?) at top of ps1 main ram
}
//==========================================================================
